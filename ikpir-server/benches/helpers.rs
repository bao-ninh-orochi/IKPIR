//! Shared bench helpers: CSV writer + simple statistics over a `f64` sample.
//! Mirrors `segmented-cuckoo/benches/helpers.rs` so bench output lives in
//! `results/` at the workspace root with a consistent format.
