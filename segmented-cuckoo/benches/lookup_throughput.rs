...
const NUM_BUCKETS_VALUES: &[u32] = &[1 << 16, 1 << 18];
...
fn main() {
    ...
    let pow3_num_buckets: &[u32] = &[3u32.pow(9), 3u32.pow(10)]; // 19683, 59049
    // Standard 4-ary num_buckets (power of 4) sized comparably to NUM_BUCKETS_VALUES.
    let pow4_num_buckets: &[u32] = &[4u32.pow(8), 4u32.pow(9)]; // 65536, 262144
