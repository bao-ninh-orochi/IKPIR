...
/// ```
pub fn hash_item_segmented_2ary(item: &[u8], segment_size: u32, fingerprint_bits: u32) -> (u32, [u32; 4]) {
...
/// ```
pub fn all_indices_segmented_2ary(cur_index: u32, fingerprint: u32, segment_size: u32) -> [u32; 4] {
