    ...
    B::Response: Clone,
{
    ...
    writeln!(
        csv_answer,
        "{},{arity},{num_buckets},{},{},{lwe_dim_eff},{batch},{:.2},{:.2},{:.2},{:.2},{query_bytes},{response_bytes},{cps},{row_width},{segment_rows},{:.4}",
    ...
    writeln!(
        csv_query,
        "{},{arity},{num_buckets},{},{},{lwe_dim_eff},{batch},{:.2},{:.2},{:.2},{:.2},{query_bytes},{cps},{row_width},{segment_rows},{:.4}",
        cli.backend, cli.bucket_size, cli.value_bits,
    ...
    writeln!(
        csv_decode,
        "{},{arity},{num_buckets},{},{},{lwe_dim_eff},{batch},{:.2},{:.2},{:.2},{:.2},{cps},{row_width},{segment_rows},{:.4}",
        cli.backend, cli.bucket_size, cli.value_bits,
